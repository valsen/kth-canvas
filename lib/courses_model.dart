...
List<CanvasCourse> canvasCoursesFromJson(String str) => List<CanvasCourse>.from(json.decode(str).map((x) => CanvasCourse.fromJson(x)));

String canvasCourseToJson(List<CanvasCourse> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
